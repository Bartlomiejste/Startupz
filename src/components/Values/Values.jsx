...
import { ImgBulb, ValuesContainer, ValuesImg, ValuesSteps, ValuesText, ValuesTitle } from '../../ui/Values/ValuesUi';
...
export const Values = () => {
    ...
    const stepsData = [
        ...
        { title: '02. People', description: 'Talent is what enable us to create great companies.', customWidth: '351px', customPadding: '' },
    ];
...
<ValuesContainer>
    <ValuesText>
        ...
        <ValuesImg><ImgBulb src={Bulb} alt="Bulb" /></ValuesImg>
    </ValuesText>
    <ValuesSteps>
