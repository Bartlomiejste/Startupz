...
import {
  ...
  FooterWrapper,
  Title,
} from "../../ui/Footer/Footer.styled.jsx";
    ...
    <FooterContainer>
      ...
      <FooterWrapper>
        ...
        <FooterInformation>
          ...
          <FooterSocialMedia>
            <FooterImg src={Twitter} alt="TwitterLogo" />
          </FooterSocialMedia>
          <FooterSocialMedia>
            <FooterImg src={Linkedin} alt="LinkedinLogo" />
          </FooterSocialMedia>
          <FooterSocialMedia>
            <FooterImg src={Instagram} alt="InstagramLogo" />
          </FooterSocialMedia>
        </FooterInformation>
      </FooterWrapper>
    </FooterContainer>
